...
.nav-header{display:flex;justify-content:space-between;align-items:center;padding:12px 24px;border-bottom:1px solid var(--rule,rgba(255,255,255,.14))}
.nav-title{font-weight:600;font-size:16px;color:var(--ink-1,#f8fafc);letter-spacing:0.5px;text-transform:uppercase}
.nav-toggle-label{display:block;cursor:pointer;width:30px;height:24px;position:relative;z-index:101}
.nav-toggle-label span{display:block;width:100%;height:2px;background:var(--ink-1,#f8fafc);position:absolute;transition:all 0.3s ease;left:0}
...
.nav-links{display:none;flex-direction:column;position:absolute;top:100%;left:0;right:0;background:var(--bg,#0f172a);border-bottom:1px solid var(--rule,rgba(255,255,255,.14));padding:12px 24px}
