...
**5,641 canonical ringers** have 50 or more tower appearances on a single bell,
...
Appearances before a first conducted peal, using `performance_ringers.conductor`.

- **72.5%** of the cohort ever conduct a peal recorded in this corpus.
- Among those who do, the median wait is **11 appearances**; the mean is **34**,
  pulled up by a long tail (p25 = 2, p75 = 40).

Conducting is common, and most who conduct do so early — within their first
dozen appearances. The long mean is the minority who conduct late or, against the
denominator, never.
